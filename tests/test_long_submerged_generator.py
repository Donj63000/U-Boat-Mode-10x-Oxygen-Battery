...
class LongSubmergedGeneratorTests(unittest.TestCase):
    ...
    def test_generator_keeps_surface_oxygen_vanilla_and_runtime_safe(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(manifest["version"], "1.4.13")
            self.assertEqual(manifest["assemblyName"], "LongSubmerged10xPatch_1_4_13")
            ...
            self.assertIn('private const string RuntimeVersion = "1.4.13";', runtime_patch_text)
            self.assertIn("Runtime patch loaded v", runtime_patch_text)
            self.assertIn('new Harmony("donj.longsubmerged10x.runtimefix1413")', runtime_patch_text)
