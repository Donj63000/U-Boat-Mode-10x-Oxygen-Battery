...
class LongSubmergedGeneratorTests(unittest.TestCase):
    def test_generator_keeps_surface_oxygen_vanilla_and_runtime_safe(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(manifest["assemblyName"], "LongSubmerged10xPatch_1_4_6")
            ...
            self.assertIn('private const string RuntimeVersion = "1.4.6";', runtime_patch_text)
            ...
            self.assertIn("Je ne patche plus Resource.UpdateAmount en 1.4.6", runtime_patch_text)
