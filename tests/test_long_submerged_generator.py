...
class LongSubmergedGeneratorTests(unittest.TestCase):
    def test_generator_keeps_ventilation_vanilla_and_patches_air_capacity(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(manifest["version"], "1.3.9")
            self.assertEqual(manifest["assemblyName"], "LongSubmerged10xPatch_1_3_9")
            ...
            self.assertIn('private const string RuntimeVersion = "1.3.9";', runtime_patch_text)
            ...
            self.assertIn("RuntimeSettingsVersion = 5", runtime_patch_text)
