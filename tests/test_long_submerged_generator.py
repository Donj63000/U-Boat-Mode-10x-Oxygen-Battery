...
class LongSubmergedGeneratorTests(unittest.TestCase):
    def test_generator_keeps_ventilation_vanilla_and_patches_air_capacity(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(manifest["version"], "1.3.8")
            self.assertEqual(manifest["assemblyName"], "LongSubmerged10xPatch_1_3_8")
            ...
            self.assertIn('private const string RuntimeVersion = "1.3.8";', runtime_patch_text)
            ...
            self.assertIn("RuntimeSettingsVersion = 4", runtime_patch_text)
            ...
            self.assertIn("Mega Batterie gain runtime active", runtime_patch_text)
