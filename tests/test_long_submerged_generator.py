...
class LongSubmergedGeneratorTests(unittest.TestCase):
    def test_generator_keeps_ventilation_vanilla_and_patches_air_capacity(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(manifest["assemblyName"], "LongSubmerged10xPatch_1_3_6")
            ...
            self.assertIn('private const string RuntimeVersion = "1.3.6";', runtime_patch_text)
            ...
            self.assertIn("RuntimeSettingsVersion", runtime_patch_text)
            ...
            self.assertIn("SetAmountQuiet", runtime_patch_text)
